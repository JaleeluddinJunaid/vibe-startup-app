      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page {
          min-height: 100vh;
          background: #f3ede3;
          background-image: radial-gradient(circle at 1px 1px, rgba(26,26,23,0.06) 1px, transparent 0);
        ...
        .brandrow {
          ...
          font-size: 13px; color: #b14a2b;
        }
        .dot { width: 9px; height: 9px; border-radius: 50%; background: #e0623f; }
        ...
        .hero h1 em { font-style: italic; color: #e0623f; }
        .hero p {
          margin-top: 18px; max-width: 48ch;
          font-size: 17px; line-height: 1.6; color: #5c574d;
        }
        ...
        .panel {
          ...
          border-radius: 18px;
          padding: 26px;
          box-shadow: 0 18px 40px -28px rgba(26,26,23,0.4);
        }
        .panel h2 {
          font-family: 'Fraunces', serif; font-weight: 600;
          font-size: 22px; margin-bottom: 4px;
        }
        .panel .sub { color: #8a8578; font-size: 14px; margin-bottom: 20px; }
        ...
        .field input {
          ...
          border: 1px solid #ddd4c4; border-radius: 11px;
          background: #faf6ee; font-family: inherit; font-size: 15px;
          color: #1a1a17; transition: border-color .15s, box-shadow .15s;
        }
        .field input:focus {
          outline: none; border-color: #e0623f;
          box-shadow: 0 0 0 3px rgba(224,98,63,0.15);
        }
        .submit {
          width: 100%; margin-top: 6px; padding: 14px;
          background: #1a1a17; color: #f3ede3;
          border: none; border-radius: 11px;
          font-family: inherit; font-size: 15px; font-weight: 600;
          cursor: pointer; transition: transform .12s, background .2s;
        }
        .submit:hover { background: #e0623f; transform: translateY(-1px); }
        .submit:disabled { opacity: .6; cursor: default; transform: none; }

        .grid { margin-top: 40px; }
        .gridhead {
          display: flex; align-items: baseline; justify-content: space-between;
          margin-bottom: 18px; border-bottom: 1px solid #ddd4c4; padding-bottom: 12px;
        }
        .gridhead h3 { font-family: 'Fraunces', serif; font-weight: 600; font-size: 20px; }
        .count { font-size: 14px; color: #8a8578; }

        .cards { display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 16px; }
        .card {
          background: #fffdf8; border: 1px solid #e4dccd; border-radius: 15px;
          padding: 20px; animation: rise .4s ease both;
        }
        .card:hover { border-color: #e0623f; }
        .avatar {
          width: 42px; height: 42px; border-radius: 12px;
          background: #f0d9cf; color: #b14a2b;
          display: flex; align-items: center; justify-content: center;
          font-family: 'Fraunces', serif; font-weight: 600; font-size: 18px;
          margin-bottom: 14px;
        }
        .card .nm { font-weight: 600; font-size: 17px; margin-bottom: 4px; }
        .card .ds { font-size: 14px; color: #6a6457; line-height: 1.5; }

        .empty, .loading { text-align: center; color: #8a8578; padding: 40px 0; font-size: 15px; }
